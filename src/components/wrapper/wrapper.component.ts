...
import { bootstrapArrowUp, bootstrapWhatsapp } from '@ng-icons/bootstrap-icons';
...
@Component({
  selector: 'bw-wrapper',
  standalone: true,
  imports: [HeaderComponent, CommonModule, NgIcon, FooterComponent, NavbarComponent],viewProviders: [provideIcons({ bootstrapWhatsapp,bootstrapArrowUp})],
